        ...
        <ul class="navbar-nav mx-auto"> <!-- Ubah me-auto menjadi mx-auto untuk center alignment -->
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li><a class="dropdown-item" href="{{url('/front-pages/penilaian')}}">Penilaian</a></li>
              <li><a class="dropdown-item" href="{{url('/penilaian/viewuserpenetapan')}}">Penetapan Tujuan</a></li>
              <li><a class="dropdown-item" href="{{url('view-user-strukturproses')}}">Struktur dan Proses</a></li>
